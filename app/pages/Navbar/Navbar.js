...
export function Navbar() {
  return (
    <div className="w-full top-0 h-16 bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 fixed border-b-2 z-50">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-bold hidden sm:block">Book Exchange</span>
        </div>
